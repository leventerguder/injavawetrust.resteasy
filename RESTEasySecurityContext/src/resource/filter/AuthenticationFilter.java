...
public class AuthenticationFilter implements javax.ws.rs.container.ContainerRequestFilter {
	...
	// - Check PermitAll annotation, if it is present then no need to check anything
	// further
	// - Check DenyAll annotation, if it is present then return with access-denied
	// - Check RolesAllowed annotation, and fetch the roles required from annotation.
	// Get authorization information from request and match it as per application
	// logic. If authorization is successful, give the access otherwise return
	// access-denied
	...
	private boolean isUserAllowed(final String username, final String password, final Set<String> rolesSet) {
		...
		if ("injavawetrust".equals(username) && password.equals(password)) {
