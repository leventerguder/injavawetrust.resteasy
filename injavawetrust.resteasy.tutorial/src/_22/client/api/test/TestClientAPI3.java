...
public class TestClientAPI3 {

	public static void main(String[] args) {

		String url = "http://localhost:8080/injavawetrust.resteasy.tutorial/library-client-api/book";
...
//		 
		...
		Book employee = response.readEntity(new GenericType<Book>(){});
